...
class TestResultEnvironment:
    ...
    GradingParameters = {
        ...
        'XRayHighRateEfficiency_min_allowed_efficiency_100':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_edge_100':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_150':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_edge_150':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_200':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_edge_200':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_250':0,
        'XRayHighRateEfficiency_min_allowed_efficiency_edge_250':0,
        'XRayHighRateEfficiency_max_allowed_loweff_A_50':10,
        'XRayHighRateEfficiency_max_allowed_loweff_A_100':10,
        'XRayHighRateEfficiency_max_allowed_loweff_A_150':10,
        'XRayHighRateEfficiency_max_allowed_loweff_A_200':10,
        'XRayHighRateEfficiency_max_allowed_loweff_A_250':10,
        'XRayHighRateEfficiency_max_allowed_loweff_B_50':20,
        'XRayHighRateEfficiency_max_allowed_loweff_B_100':20,
        'XRayHighRateEfficiency_max_allowed_loweff_B_150':20,
        'XRayHighRateEfficiency_max_allowed_loweff_B_200':20,
        'XRayHighRateEfficiency_max_allowed_loweff_B_250':20,
        ...
        'XRayHighRate_SCurve_Noise_Threshold_50':400,
        'XRayHighRate_SCurve_Noise_Threshold_150':400,
    }
