...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    ...
    def PopulateResultData(self):
        ...
        HitMapOverview = self.ParentObject.ResultData['SubTestResults']['HitOverview_{Rate}'.format(Rate=Rate) if len(Rate)>0 else 'HitOverview'].ResultData['Plot']['ROOTObject']
        ...
        self.Title = 'Hits distribution {Rate} inner/edge/corner'.format(Rate=Rate)
        self.SaveCanvas()
        ROOT.gPad.SetLogy(0)
        ROOT.gPad.SetLogx(0)