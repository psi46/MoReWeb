...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    def CustomInit(self):
        self.Name = "CMSPixel_ModuleTestGroup_HighRateTest_HighRatePixelMapModule_Chips_TestResult"
    ...
    def PopulateResultData(self):
        ...
        summary = chip.ResultData['SubTestResults']['HighRatePixelMapSummary']
        ...
        for roc in range(nRocs):
            ...
            for key in keys:
                ...
                if unit == " [1]":
                    unit = ""
                self.ResultData['Table']['BODY'][-1].append("%s%s" % (str(value), unit))
                totals[idx] += value
                idx += 1
