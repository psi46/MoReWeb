...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    def CustomInit(self):
        self.Name = 'CMSPixel_QualificationGroup_Fulltest_Vtrim_TestResult'
        self.NameSingle = 'Vtrim'
    ...
    def PopulateResultData(self):
        ...
        if self.ResultData['Plot']['ROOTObject']:
            ...
            for i in self.ParentObject.ResultData['SubTestResults']['Chips'].ResultData['SubTestResults']:
                ...
                strValue = ''
                Keys=['Chips', '%s'%i, 'DacParameterOverview', 'DacParameters35','KeyValueDictPairs.json', 'vtrim', 'Value']
            ...
            self.ResultData['Plot']['ROOTObject'].GetYaxis().SetTitle('Vtrim [Vcal]')
        ...
        self.SaveCanvas()
        self.ResultData['Plot']['Caption'] = 'Vtrim'
        ...
        self.ResultData['KeyList'] = ['mu','vtrimspread']
