...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    def CustomInit(self):
        self.Name = 'CMSPixel_QualificationGroup_Fulltest_Vana_TestResult'
    ...
    def PopulateResultData(self):
        ...
        if self.ResultData['Plot']['ROOTObject']:
            ...
            for i in self.ParentObject.ResultData['SubTestResults']['Chips'].ResultData['SubTestResults']:
                ...
                strValue = ''
                Keys=['Chips', '%s'%i, 'DacParameterOverview', 'DacParameters35','KeyValueDictPairs.json', 'vana', 'Value']
            ...
            self.ResultData['Plot']['ROOTObject'].GetYaxis().SetTitle('Vana [Vcal]')
        ...
        self.SaveCanvas()
        self.ResultData['Plot']['Caption'] = 'Vana'
        ...
        self.ResultData['KeyList'] = ['mu','vanaspread']
