...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    def CustomInit(self):
        self.Name = 'CMSPixel_QualificationGroup_Fulltest_VthrComp_TestResult'
        self.NameSingle = 'VthrComp'
    ...
    def PopulateResultData(self):
        ...
        if self.ResultData['Plot']['ROOTObject']:
            ...
            for i in self.ParentObject.ResultData['SubTestResults']['Chips'].ResultData['SubTestResults']:
                ...
                strValue = ''
                Keys=['Chips', '%s'%i, 'DacParameterOverview', 'DacParameters35','KeyValueDictPairs.json', 'vthrcomp', 'Value']
                ...
                Value = int(Value)
                Sum += Value
                if (VthrCompMax<Value):
                    VthrCompMax=Value
                if (VthrCompMin>Value):
                    VthrCompMin=Value
            ...
            Difference = VthrCompMax -  VthrCompMin
            ...
            self.ResultData['Plot']['ROOTObject'].GetYaxis().SetTitle('VthrComp [Vcal]')
        ...
        self.SaveCanvas()
        self.ResultData['Plot']['Caption'] = 'VthrComp'

        self.ResultData['KeyValueDictPairs'] = {
            'vthrcompspread': {
                'Value': '{0:}'.format(Difference),
                'Label': 'VthrComp spread'
            },
            'mu': {
        ...
        self.ResultData['KeyList'] = ['mu','vthrcompspread']
