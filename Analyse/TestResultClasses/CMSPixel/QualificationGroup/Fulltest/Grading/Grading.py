...
#         print 'C:',self.getNumberOfRocsWithGrade('3',SubGradings['PixelDefects'])        
 ...
 '''
            ...
            if ModuleGrade == 1 and BadRocs > 1:
                ModuleGrade = 2
            if ModuleGrade == 1 and RecalculatedCurrentAtVoltage150V and RecalculatedCurrentAtVoltage150V > self.TestResultEnvironmentObject.GradingParameters['currentBm10']:
                ModuleGrade = 2
            if ModuleGrade == 1 and RecalculatedCurrentVariation and RecalculatedCurrentVariation > self.TestResultEnvironmentObject.GradingParameters['slopeivB']:
                ModuleGrade = 2
            if BadRocs > 2:
                ModuleGrade = 3
