...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    ...
    def PopulateResultData(self):
        ...
        for i in self.ParentObject.ResultData['SubTestResults']['Chips'].ResultData['SubTestResults']:
            ...
            histo = ChipTestResultObject.ResultData['SubTestResults']['PixelAlive'].ResultData['Plot']['ROOTObject']

            if not histo:
                print 'cannot get PixelAlive histo for chip ',ChipTestResultObject.Attributes['ChipNo']
                continue
