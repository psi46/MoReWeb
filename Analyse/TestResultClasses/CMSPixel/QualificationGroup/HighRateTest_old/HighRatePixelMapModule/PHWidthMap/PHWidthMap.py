...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    def CustomInit(self):
        self.Name = "CMSPixel_ModuleTestGroup_HighRateTest_HighRatePixelMapModule_PHWidthMap_TestResult"
        self.NameSingle = "PHWidthMap"
        ...
        if self.verbose:
            ...
            print "".ljust(len(tag), '=')
            print tag
        self.Attributes['TestedObjectType'] = 'HighRatePHWidthMapModule'
    ...
    def PopulateResultData(self):
        ...
        for roc in range(len(chips.ResultData['SubTestResults'])):
            ...
            pixmap = chip.ResultData['SubTestResults']['HighRatePHWidthMap'].ResultData['Plot']['ROOTObject']
