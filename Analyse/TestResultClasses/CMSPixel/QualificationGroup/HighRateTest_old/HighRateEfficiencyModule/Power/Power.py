...
class TestResult(AbstractClasses.GeneralTestResult.GeneralTestResult):
    def CustomInit(self):
        self.Name = "CMSPixel_ModuleTestGroup_HighRateTest_HighRateEfficiencyModule_Power_TestResult"
    ...
    def PopulateResultData(self):
        ...
        iana = self.FileHandle.Get("hr_efficiency_analog_current")
        vana = self.FileHandle.Get("hr_efficiency_analog_voltage")
        idig = self.FileHandle.Get("hr_efficiency_digital_current")
        vdig = self.FileHandle.Get("hr_efficiency_digital_voltage")
