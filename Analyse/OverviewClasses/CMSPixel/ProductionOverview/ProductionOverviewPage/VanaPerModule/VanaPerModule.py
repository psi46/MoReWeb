...
class ProductionOverview(AbstractClasses.GeneralProductionOverview.GeneralProductionOverview):
    ...
    def CustomInit(self):
        self.NameSingle='VanaPerModule'
    	self.Name='CMSPixel_ProductionOverview_%s'%self.NameSingle
        self.Title = 'Vana difference'
        self.DisplayOptions = {
            'Width': 1,
        }
        self.SubPages = []
    ...
    def GenerateOverview(self):
            ...
            for RowTuple in Rows:
                if RowTuple['ModuleID'] == ModuleID:
                    ...
                    if TestType == self.Attributes['Test']:
                        ...
                        Value = self.GetJSONValue([RowTuple['RelativeModuleFinalResultsPath'], RowTuple['FulltestSubfolder'], 'Vana', 'KeyValueDictPairs.json', "vanaspread", 'Value'])
        ...
        Histogram.GetXaxis().SetTitle("Vana [ADC]")
        ...
        Subtitle = "Vana spread, modules:{NROCs}".format(NROCs=NROCs)
