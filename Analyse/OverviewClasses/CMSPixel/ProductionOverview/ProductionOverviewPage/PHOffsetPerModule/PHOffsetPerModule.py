...
class ProductionOverview(AbstractClasses.GeneralProductionOverview.GeneralProductionOverview):
    ...
    def CustomInit(self):
        self.NameSingle='PHOffsetPerModule'
    	self.Name='CMSPixel_ProductionOverview_%s'%self.NameSingle
        self.Title = 'PHOffset difference'
        self.DisplayOptions = {
            'Width': 1,
        }
        self.SubPages = []
    ...
    def GenerateOverview(self):
            ...
            for RowTuple in Rows:
                if RowTuple['ModuleID'] == ModuleID:
                    ...
                    if TestType == self.Attributes['Test']:
                        ...
                        Value = self.GetJSONValue([RowTuple['RelativeModuleFinalResultsPath'], RowTuple['FulltestSubfolder'], 'PHOffset', 'KeyValueDictPairs.json', "phoffsetspread", 'Value'])
        ...
        Histogram.GetXaxis().SetTitle("PHOffset [ADC]")
        ...
        Subtitle = "PHOffset spread, modules:{NROCs}".format(NROCs=NROCs)
