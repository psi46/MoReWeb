...
class ProductionOverview(AbstractClasses.GeneralProductionOverview.GeneralProductionOverview):
    ...
    def CustomInit(self):
        self.NameSingle='VthrCompPerModule'
    	self.Name='CMSPixel_ProductionOverview_%s'%self.NameSingle
        self.Title = 'VthrComp difference'
        self.DisplayOptions = {
            'Width': 1,
        }
        self.SubPages = []
    ...
    def GenerateOverview(self):
            ...
            for RowTuple in Rows:
                if RowTuple['ModuleID'] == ModuleID:
                    ...
                    if TestType == self.Attributes['Test']:
                        ...
                        Value = self.GetJSONValue([RowTuple['RelativeModuleFinalResultsPath'], RowTuple['FulltestSubfolder'], 'VthrComp', 'KeyValueDictPairs.json', "vthrcompspread", 'Value'])
        ...
        Histogram.GetXaxis().SetTitle("VthrComp [ADC]")
        ...
        Subtitle = "VthrComp spread, modules:{NROCs}".format(NROCs=NROCs)
