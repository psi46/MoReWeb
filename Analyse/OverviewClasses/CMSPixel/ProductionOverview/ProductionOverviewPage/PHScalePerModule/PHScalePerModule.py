...
class ProductionOverview(AbstractClasses.GeneralProductionOverview.GeneralProductionOverview):
    ...
    def CustomInit(self):
        self.NameSingle='PHScalePerModule'
    	self.Name='CMSPixel_ProductionOverview_%s'%self.NameSingle
        self.Title = 'PHScale difference'
        self.DisplayOptions = {
            'Width': 1,
        }
        self.SubPages = []
    ...
    def GenerateOverview(self):
            ...
            for RowTuple in Rows:
                if RowTuple['ModuleID'] == ModuleID:
                    ...
                    if TestType == self.Attributes['Test']:
                        ...
                        Value = self.GetJSONValue([RowTuple['RelativeModuleFinalResultsPath'], RowTuple['FulltestSubfolder'], 'PHScale', 'KeyValueDictPairs.json', "phscalespread", 'Value'])
        ...
        Histogram.GetXaxis().SetTitle("PHScale [ADC]")
        ...
        Subtitle = "PHScale spread, modules:{NROCs}".format(NROCs=NROCs)
